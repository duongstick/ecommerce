...
class BrandProController extends Controller
{
    ...
    public function show_brand_pro(){
        $show_brand_pro = Brand::orderBy('brand_id','DESC')->get();
    	$manager_brand_product  = view('admin.show_brand_pro')->with('show_brand_pro',$show_brand_pro);
    	return view('admin_layout')->with('admin.show_brand_pro', $manager_brand_product);
    ...
    public function save_brand_pro(Request $req){
        $data = $req->all();
        $brand = new Brand();
        $brand->brand_name = $data['brand_pro_name'];
        //$brand->brand_slug = $data['brand_slug'];
        $brand->brand_desc = $data['brand_pro_desc'];
        $brand->brand_status = $data['brand_pro_status'];
        $brand->save();
        // $data = array();
    ...
    public function edit_brand_pro($brand_pro_id){
        ...
        $edit_brand_pro = Brand::where('brand_id',$brand_pro_id)->get();
